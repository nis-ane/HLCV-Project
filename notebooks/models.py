...
class Generator(nn.Module):
    def __init__(self,
        ...
        # Adjust the input dimension of the mlp layer to match the combined input
        combined_input_dim = 1024 + 3 * 368 * 544  # Adjust this according to the actual shape

        self.mlp = nn.Linear(combined_input_dim, (self.initialize_size * 8) * self.dim)
