...
class SwinTransformerBlock(nn.Module):
    def __init__(
            self,  dim, input_resolution, window_size = (12,6) , shift_size = 0):
...
class SwinBlock(nn.Module):
    def __init__(self, dims, ip_res, window_size =(12,6), ss_size = 3):
        super().__init__()
        self.swtb1 = SwinTransformerBlock(dim=dims, input_resolution=ip_res, window_size = window_size)
        self.swtb2 = SwinTransformerBlock(dim=dims, input_resolution=ip_res, window_size = window_size, shift_size=ss_size)
